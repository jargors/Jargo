...
# the java/ directory and doc/autogenerated.tex. IMPORTANT: the 'all', 'java',
# and 'tex' targets require noweb programs 'notangle' and 'noweave' in your
# PATH.  Additionally, noweb must be compiled using the icont option (instead
# of awk).
...
# This target produces all the Java files in java/ and also
# doc/autogenerated.tex.  (most people are going to use 'src' target of
# Makefile, causing 'all' target of this file to be built. The _precheck is
# added to this target. Running 'make src java' or 'make src tex' will skip the
# _precheck.)
...
# This target produces doc/autogenerated.tex.
tex : doc/autogenerated.tex

# Remove *.java and doc/autogenerated.tex files
clean :
	@rm -f $(JAVA1) $(JAVA2) $(JAVA3) $(JAVA4)
	@rm -f doc/autogenerated.tex

# The below instructions explain how to build Java files and doc/autogenerated.tex.
################################################################################
...
# Build doc/autogenerated.tex using 'noweave'. The order of the noweave arguments
