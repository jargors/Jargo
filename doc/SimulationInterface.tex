...
\LA{}Set storage interface~{\nwtagstyle{}\subpageref{NW3Bji2p-4NPO9X-1}}\RA{}
...
\subsubsection{{\tt{}\protect\nosublabel{NW3Bji2p-48YU8C-3-u5}\protect\nwindexuse{setStorageInterface}{setStorageInterface}{NW3Bji2p-4NPO9X-1}setStorageInterface}(1)}
\nwenddocs{}\nwbegincode{19}\sublabel{NW3Bji2p-4NPO9X-1}\nwmargintag{{\nwtagstyle{}\subpageref{NW3Bji2p-4NPO9X-1}}}\moddef{Set storage interface~{\nwtagstyle{}\subpageref{NW3Bji2p-4NPO9X-1}}}\endmoddef\nwused{\\{NW3Bji2p-48YU8C-1}}
public void setStorageInterface(StorageInterface src) \{
  storage = src;
\}
\nwindexdefn{setStorageInterface}{setStorageInterface}{NW3Bji2p-4NPO9X-1}\eatline
\nwidentdefs{\\{{setStorageInterface}{setStorageInterface}}}\nwidentuses{\\{{storage}{storage}}}\nwindexuse{storage}{storage}{NW3Bji2p-4NPO9X-1}\nwendcode{}\nwbegindocs{20}\nwdocspar
...
\nwixlogsorted{c}{{Set storage interface}{NW3Bji2p-4NPO9X-1}{\nwixu{NW3Bji2p-48YU8C-1}\nwixd{NW3Bji2p-4NPO9X-1}}}%
...
\nwixlogsorted{i}{{setStorageInterface}{setStorageInterface}}%
