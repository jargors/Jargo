...
\nwenddocs{}\nwbegincode{11}\sublabel{NW3zOIuJ-1eKCCy-1}\nwmargintag{{\nwtagstyle{}\subpageref{NW3zOIuJ-1eKCCy-1}}}\moddef{Public methods~{\nwtagstyle{}\subpageref{NW3zOIuJ-1eKCCy-1}}}\endmoddef\nwused{\\{NW3zOIuJ-1xm30x-1}}
  ...
  \LA{}Load vertices map~{\nwtagstyle{}\subpageref{NW3zOIuJ-3xdAnJ-1}}\RA{}
  \LA{}Load edges map~{\nwtagstyle{}\subpageref{NW3zOIuJ-2lPetT-1}}\RA{}
...
\subsection{{\tt{}\protect\nwindexuse{loadVerticesMap}{loadVerticesMap}{NW3zOIuJ-3xdAnJ-1}loadVerticesMap}(1)}
Be mindful, any change to {\tt{}src} will appear in {\tt{}lu{\char95}vertices}.
\nwenddocs{}\nwbegincode{15}\sublabel{NW3zOIuJ-3xdAnJ-1}\nwmargintag{{\nwtagstyle{}\subpageref{NW3zOIuJ-3xdAnJ-1}}}\moddef{Load vertices map~{\nwtagstyle{}\subpageref{NW3zOIuJ-3xdAnJ-1}}}\endmoddef\nwused{\\{NW3zOIuJ-1eKCCy-1}}
public void loadVerticesMap(Map<Integer, int[]> src) \{
  lu_vertices = src;
\}
\nwindexdefn{loadVerticesMap}{loadVerticesMap}{NW3zOIuJ-3xdAnJ-1}\eatline
\nwidentdefs{\\{{loadVerticesMap}{loadVerticesMap}}}\nwendcode{}\nwbegindocs{16}\nwdocspar
\subsection{{\tt{}\protect\nwindexuse{loadEdgesMap}{loadEdgesMap}{NW3zOIuJ-2lPetT-1}loadEdgesMap}(1)}
Be mindful, any change to {\tt{}src} will appear in {\tt{}lu{\char95}edges}.
\nwenddocs{}\nwbegincode{17}\sublabel{NW3zOIuJ-2lPetT-1}\nwmargintag{{\nwtagstyle{}\subpageref{NW3zOIuJ-2lPetT-1}}}\moddef{Load edges map~{\nwtagstyle{}\subpageref{NW3zOIuJ-2lPetT-1}}}\endmoddef\nwused{\\{NW3zOIuJ-1eKCCy-1}}
public void loadEdgesMap(Map<int[], int[]> src) \{
  lu_edges = src;
\}
\nwindexdefn{loadEdgesMap}{loadEdgesMap}{NW3zOIuJ-2lPetT-1}\eatline
\nwidentdefs{\\{{loadEdgesMap}{loadEdgesMap}}}\nwendcode{}\nwbegindocs{18}\nwdocspar
...
\nwixlogsorted{c}{{Load edges map}{NW3zOIuJ-2lPetT-1}{\nwixu{NW3zOIuJ-1eKCCy-1}\nwixd{NW3zOIuJ-2lPetT-1}}}%
\nwixlogsorted{c}{{Load GTree}{NW3zOIuJ-b7Jka-1}{\nwixu{NW3zOIuJ-1eKCCy-1}\nwixd{NW3zOIuJ-b7Jka-1}}}%
\nwixlogsorted{c}{{Load vertices map}{NW3zOIuJ-3xdAnJ-1}{\nwixu{NW3zOIuJ-1eKCCy-1}\nwixd{NW3zOIuJ-3xdAnJ-1}}}%
...
\nwixlogsorted{i}{{loadEdgesMap}{loadEdgesMap}}%
\nwixlogsorted{i}{{loadGTree}{loadGTree}}%
\nwixlogsorted{i}{{loadVerticesMap}{loadVerticesMap}}%
