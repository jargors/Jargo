...
\nwidentdefs{\\{{client}{client}}\\{{communicator}{communicator}}\\{{lu{\char95}nodes}{lu:unnodes}}\\{{storage}{storage}}\\{{tools}{tools}}}\nwendcode{}\nwbegindocs{20}\hi{Settings.} Settings objects configure various aspects of the simulation.
