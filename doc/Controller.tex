...
\LA{}Get vertices map~{\nwtagstyle{}\subpageref{NW2ZDXo8-1hNAaD-1}}\RA{}
\LA{}Get edges map~{\nwtagstyle{}\subpageref{NW2ZDXo8-9hRaO-1}}\RA{}
...
\subsubsection{{\tt{}\protect\nwindexuse{getVerticesMap}{getVerticesMap}{NW2ZDXo8-1hNAaD-1}getVerticesMap}(0)}
\nwenddocs{}\nwbegincode{47}\sublabel{NW2ZDXo8-1hNAaD-1}\nwmargintag{{\nwtagstyle{}\subpageref{NW2ZDXo8-1hNAaD-1}}}\moddef{Get vertices map~{\nwtagstyle{}\subpageref{NW2ZDXo8-1hNAaD-1}}}\endmoddef\nwused{\\{NW2ZDXo8-bF3Hn-1}}
public final Map<Integer, int[]> getVerticesMap() \{
  return lu_vertices;
\}
\nwindexdefn{getVerticesMap}{getVerticesMap}{NW2ZDXo8-1hNAaD-1}\eatline
\nwidentdefs{\\{{getVerticesMap}{getVerticesMap}}}\nwidentuses{\\{{lu{\char95}vertices}{lu:unvertices}}}\nwindexuse{lu{\char95}vertices}{lu:unvertices}{NW2ZDXo8-1hNAaD-1}\nwendcode{}\nwbegindocs{48}\nwdocspar
\subsubsection{{\tt{}\protect\nwindexuse{getEdgesMap}{getEdgesMap}{NW2ZDXo8-9hRaO-1}getEdgesMap}(0)}
\nwenddocs{}\nwbegincode{49}\sublabel{NW2ZDXo8-9hRaO-1}\nwmargintag{{\nwtagstyle{}\subpageref{NW2ZDXo8-9hRaO-1}}}\moddef{Get edges map~{\nwtagstyle{}\subpageref{NW2ZDXo8-9hRaO-1}}}\endmoddef\nwused{\\{NW2ZDXo8-bF3Hn-1}}
public final Map<int[], int[]> getEdgesMap() \{
  return lu_edges;
\}
\nwindexdefn{getEdgesMap}{getEdgesMap}{NW2ZDXo8-9hRaO-1}\eatline
\nwidentdefs{\\{{getEdgesMap}{getEdgesMap}}}\nwidentuses{\\{{lu{\char95}edges}{lu:unedges}}}\nwindexuse{lu{\char95}edges}{lu:unedges}{NW2ZDXo8-9hRaO-1}\nwendcode{}\nwbegindocs{50}\nwdocspar
\subsubsection{{\tt{}save}(1)}
\nwenddocs{}\nwbegincode{51}\sublabel{NW2ZDXo8-2OKmqF-1}\nwmargintag{{\nwtagstyle{}\subpageref{NW2ZDXo8-2OKmqF-1}}}\moddef{Save backup~{\nwtagstyle{}\subpageref{NW2ZDXo8-2OKmqF-1}}}\endmoddef\nwused{\\{NW2ZDXo8-bF3Hn-1}}
...
\}
\nwidentuses{\\{{lu{\char95}vertices}{lu:unvertices}}\\{{storage}{storage}}}\nwindexuse{lu{\char95}vertices}{lu:unvertices}{NW2ZDXo8-1EuI65-1}\nwindexuse{storage}{storage}{NW2ZDXo8-1EuI65-1}\nwendcode{}\nwbegindocs{63}\nwdocspar
...
\nwixlogsorted{c}{{Get edges map}{NW2ZDXo8-9hRaO-1}{\nwixu{NW2ZDXo8-bF3Hn-1}\nwixd{NW2ZDXo8-9hRaO-1}}}%
\nwixlogsorted{c}{{Get vertices map}{NW2ZDXo8-1hNAaD-1}{\nwixu{NW2ZDXo8-bF3Hn-1}\nwixd{NW2ZDXo8-1hNAaD-1}}}%
...
\nwixlogsorted{i}{{getEdgesMap}{getEdgesMap}}%
\nwixlogsorted{i}{{getSimulationWorldTime}{getSimulationWorldTime}}%
\nwixlogsorted{i}{{getVerticesMap}{getVerticesMap}}%
