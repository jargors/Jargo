...
\LA{}Set option for strict route updates~{\nwtagstyle{}\subpageref{NWvbkzY-2gqwcH-1}}\RA{}
...
\subsubsection{{\tt{}\protect\nwindexuse{setStrictRouteUpdates}{setStrictRouteUpdates}{NWvbkzY-2gqwcH-1}setStrictRouteUpdates}(1)}
\nwenddocs{}\nwbegincode{21}\sublabel{NWvbkzY-2gqwcH-1}\nwmargintag{{\nwtagstyle{}\subpageref{NWvbkzY-2gqwcH-1}}}\moddef{Set option for strict route updates~{\nwtagstyle{}\subpageref{NWvbkzY-2gqwcH-1}}}\endmoddef\nwused{\\{NWvbkzY-3YjONp-1}}
public void setStrictRouteUpdates(boolean flag) \{
  ENFORCE_STRICT_ROUTE_UPDATES = flag;
\}
\nwindexdefn{setStrictRouteUpdates}{setStrictRouteUpdates}{NWvbkzY-2gqwcH-1}\eatline
\nwidentdefs{\\{{setStrictRouteUpdates}{setStrictRouteUpdates}}}\nwendcode{}\nwbegindocs{22}\nwdocspar
...
\nwixlogsorted{c}{{Set option for strict route updates}{NWvbkzY-2gqwcH-1}{\nwixu{NWvbkzY-3YjONp-1}\nwixd{NWvbkzY-2gqwcH-1}}}%
...
\nwixlogsorted{i}{{queryServerCurrentLoad}{queryServerCurrentLoad}}%
...
\nwixlogsorted{i}{{setStrictRouteUpdates}{setStrictRouteUpdates}}%
