...
\nwidentdefs{\\{{communicator}{communicator}}\\{{distance}{distance}}\\{{locations}{locations}}\\{{r{\char95}collection{\char95}period}{r:uncollection:unperiod}}\\{{requests}{requests}}\\{{s{\char95}collection{\char95}period}{s:uncollection:unperiod}}}\nwendcode{}\nwbegindocs{10}\nwdocspar
