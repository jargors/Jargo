...
\nwenddocs{}\nwbegincode{13}\sublabel{NW2q3QGT-4VlNed-1}\nwmargintag{{\nwtagstyle{}\subpageref{NW2q3QGT-4VlNed-1}}}\moddef{\code{}Client\edoc{} public methods~{\nwtagstyle{}\subpageref{NW2q3QGT-4VlNed-1}}}\endmoddef\nwused{\\{NW2q3QGT-3hr6Rs-1}}
  ...
  \LA{}Load road network~{\nwtagstyle{}\subpageref{NW2q3QGT-1JUvcB-1}}\RA{}
\nwendcode{}\nwbegindocs{14}\nwdocspar
...
\subsubsection{{\tt{}\protect\nwindexuse{loadRoadNetwork}{loadRoadNetwork}{NW2q3QGT-1JUvcB-1}loadRoadNetwork}(0)}
Be mindful, the Client {\tt{}\protect\nwindexuse{loadRoadNetwork}{loadRoadNetwork}{NW2q3QGT-1JUvcB-1}loadRoadNetwork}(0) method is different
from the Controller {\tt{}\protect\nwindexuse{loadRoadNetwork}{loadRoadNetwork}{NW2q3QGT-1JUvcB-1}loadRoadNetwork}(1) method. The Client method registers
the vertices and edges cache from Storage into Tools, while the Controller
method populates the cache and Storage with the on-disk road network file.
\nwenddocs{}\nwbegincode{31}\sublabel{NW2q3QGT-1JUvcB-1}\nwmargintag{{\nwtagstyle{}\subpageref{NW2q3QGT-1JUvcB-1}}}\moddef{Load road network~{\nwtagstyle{}\subpageref{NW2q3QGT-1JUvcB-1}}}\endmoddef\nwused{\\{NW2q3QGT-4VlNed-1}}
...
\}
\nwindexdefn{loadRoadNetwork}{loadRoadNetwork}{NW2q3QGT-1JUvcB-1}\eatline
\nwidentdefs{\\{{loadRoadNetwork}{loadRoadNetwork}}}\nwidentuses{\\{{communicator}{communicator}}\\{{tools}{tools}}}\nwindexuse{communicator}{communicator}{NW2q3QGT-1JUvcB-1}\nwindexuse{tools}{tools}{NW2q3QGT-1JUvcB-1}\nwendcode{}\nwbegindocs{32}\nwdocspar
...
\nwixlogsorted{c}{{Load road network}{NW2q3QGT-1JUvcB-1}{\nwixu{NW2q3QGT-4VlNed-1}\nwixd{NW2q3QGT-1JUvcB-1}}}%
