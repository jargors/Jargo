...
\nwidentdefs{\\{{communicator}{communicator}}\\{{locations}{locations}}\\{{r{\char95}collection{\char95}period}{r:uncollection:unperiod}}\\{{requests}{requests}}\\{{s{\char95}collection{\char95}period}{s:uncollection:unperiod}}\\{{tools}{tools}}}\nwendcode{}\nwbegindocs{10}\nwdocspar
...
\nwidentdefs{\\{{computeHaversine}{computeHaversine}}}\nwidentuses{\\{{communicator}{communicator}}\\{{tools}{tools}}}\nwindexuse{communicator}{communicator}{NW2q3QGT-1XfngC-1}\nwindexuse{tools}{tools}{NW2q3QGT-1XfngC-1}\nwendcode{}\nwbegindocs{32}\nwdocspar
